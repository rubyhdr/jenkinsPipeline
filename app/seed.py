...
BOOKS = [
    ...
    ("978044117271", "Dune", "Frank Herbert", SCI_FI, 1965, 2,
     "Politics, ecology and prophecy on the desert planet Arrakis."),
    ("978059313520", "Project Hail Mary", "Andy Weir", SCI_FI, 2021, 2,
     "A lone astronaut must save Earth with science and an unlikely friend."),
    ("978076531178", "The Three-Body Problem", "Liu Cixin", SCI_FI, 2008, 1,
    ...
    ("978013235088", "Clean Code", "Robert C. Martin", TECH, 2008, 2,
     "Principles and practices for writing readable, maintainable software."),
    ("978020161622", "The Pragmatic Programmer", "Andrew Hunt & David Thomas", TECH, 1999, 2,
     "Timeless advice for becoming a more effective developer."),
    ("978032160191", "Continuous Delivery", "Jez Humble & David Farley", TECH, 2010, 1,
     "Reliable software releases through build, test and deployment automation."),
    ("978194278878", "The DevOps Handbook", "Gene Kim et al.", TECH, 2016, 1,
     "How to create world-class agility, reliability and security in technology organisations."),
    ("978149192912", "Site Reliability Engineering", "Betsy Beyer et al.", TECH, 2016, 1,
